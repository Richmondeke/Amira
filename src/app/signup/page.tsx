...
export default function SignupPage() {
    ...
    // We can add more fields like Name later if needed, but Firebase just requires email/pwd to create the base user.
    ...
    return (
        <div className="min-h-screen bg-background-light dark:bg-[#0a0f1a] flex items-center justify-center p-4 font-display">
            {/* Background Orbs */}
            <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[var(--color-primary)]/10 dark:bg-[var(--color-primary)]/5 rounded-full blur-3xl rounded-full -z-10 animate-pulse delay-700"></div>
            <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-blue-500/10 dark:bg-blue-600/5 rounded-full blur-3xl rounded-full -z-10 animate-pulse delay-300"></div>
            ...
            <div className="w-full max-w-md bg-white/70 dark:bg-[#161e2d]/70 backdrop-blur-xl border border-gray-200 dark:border-[var(--color-border-dark)] rounded-3xl p-8 shadow-2xl">
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 mt-2">Get started deploying AI voice agents today.</p>
                </div>
                ...
                <form onSubmit={handleEmailSignup} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1.5" htmlFor="password">Create Password</label>
                        <input
                            id="password"
                            type="password"
                            required
